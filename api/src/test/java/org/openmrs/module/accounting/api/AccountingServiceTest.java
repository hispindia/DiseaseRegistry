...
/**
 * Tests {@link ${AccountingService}}.
 */
public class  AccountingServiceTest extends BaseModuleContextSensitiveTest {
	
	@Test
	public void shouldSetupContext() {
		assertNotNull(Context.getService(AccountingService.class));
	}
}
